...
public class BlinnPhongMaterial extends Material
{
	...
	public void bind(GL2 gl) throws OpenGLException
	{
		...
		gl.glUniform3f(mDiffuseUniformLocation, mDiffuseColor.x,
				mDiffuseColor.y, mDiffuseColor.z);
		gl.glUniform3f(mSpecularUniformLocation, mSpecularColor.x,
				mSpecularColor.y, mSpecularColor.z);
